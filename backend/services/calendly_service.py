...
class CalendlyService:
    ...
    async def initialize(self):
        ...
        if self.api_key:
            ...
            self.logger.warning("Calendly API key not configured - using mock responses")
    ...
    async def create_event(self, booking_id: str, appointment_type: str,
        ...
        if not self.client:
            ...
            return {
                "event_id": f"mock_event_{booking_id}",
                "status": "created",
                "start_time": start_time,
                "appointment_type": appointment_type,
                "patient_name": patient_info.get("name", "Unknown"),
                "scheduling_url": f"https://calendly.com/mock/{booking_id}",
                "mock": True
            }
    ...
    async def get_availability(self, event_type_id: str, start_date: str, end_date: str) -> Dict[str, Any]:
        ...
        if not self.client:
            ...
            return {
                "available_slots": [
                    {"start_time": f"{start_date}T09:00:00Z", "end_time": f"{start_date}T09:30:00Z"},
                    ...
                    {"start_time": f"{start_date}T15:00:00Z", "end_time": f"{start_date}T15:30:00Z"}
                ],
                "mock": True
            }
